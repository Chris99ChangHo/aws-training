...
#
# 파이프라인(dining-deploy 스테이지)이 배포한 DiningConcierge Runtime을
# 호출합니다. AGENT_RUNTIME_ARN은 agentcore deploy 출력이나
# `agentcore status`로 확인한 값을 채워 넣습니다.
import json
import os
import uuid
...
REGION = "us-west-2"
# TODO: 파이프라인이 배포한 Runtime ARN으로 교체
...
if __name__ == "__main__":
    answer = invoke_agent("강남역 근처 이탈리안 식당 추천해 주세요")
    print(answer)
